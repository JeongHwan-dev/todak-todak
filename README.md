...
| 기능               | 영역      | 내용                                                                                |
| :----------------- | :-------- | :---------------------------------------------------------------------------------- |
| 커뮤니티 기능      | 주요 기능 | 자신과 같은 유형으로 분류된 혹은 유사 유형으로 분류된 인근 지역 유저들과의 커뮤니티 |
| 같이해요 기능      | 주요 기능 | 지역 내에서 1회성 운동 모임을 개최하고 참가신청 할 수 있는 기능                     |
| 채팅 기능          | 주요 기능 | 유저간 1:1 채팅 기능                                                                |
| 지역 데이터 시각화 | 주요 기능 | 지역의 유저 데이터와 의료 정보 데이터를 시각화하여 제공                             |
| 유저 사회망 시각화 | 부가 기능 | 자신과 네트워킹이 발생하고 있는 유저들과의 사회적 연결망을 시각화하여 제공          |
...
|  이름  |    역할    |                                        개발 내용                                         |
| :----: | :--------: | :--------------------------------------------------------------------------------------: |
| 황정우 | PM 및 기획 | 스토리보드 및 와이어 프레임 작성 / 데이터 분석 / 실시간 데이터 시각화 구현 / 백엔드 개발 |
| 박정환 | Front-end  |  로그인 및 회원가입 기능 구현(client) / 커뮤니티 게시글 기능 구현(client) / 웹 스타일링  |
| 김수영 | Front-end  |                   1:1 채팅 기능 구현(client) / 채팅 페이지 웹 스타일링                   |
| 강인선 |  Back-end  |         로그인 및 회원가입 기능 구현(server) / 커뮤니티 게시글 기능 구현(server)         |
| 윤수진 |  Back-end  |                                1:1 채팅 기능 구현(server)                                |
